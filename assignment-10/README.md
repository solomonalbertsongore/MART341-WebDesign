1) The universal element is used to select everything on the page. This could be used to set the font, or other very broad styling options that will apply to
